...
private let s3 = StatusParam(value: 3, description: "GOOD", color: Color("StatusIconColor"))

private let k1 = StatusParam(value: 1, description: "NEVER", color: Color("StatusIconColor"))
...
private let r2 = StatusParam(value: 1, description: "NO", color: Color("StatusIconColor"))
